...
pa=paste('C:/Users/nan/Desktop/PNAS/Results/SimulationResults/Rsquare',sep='')
...
write.table(result,paste(pa,'/','t_test_result_.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
# threshold="0.35"
# d<-read.table(paste(pa,'/','Total Number_',threshold,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL)    
# sink(paste(pa,'/t_test',threshold,'.txt',sep=''))
# t.test(d$TargetCannon_0_Num_1,d$TargetCannon_180_Num_1)
# t.test(d$TargetCannon_Up_Num_1,d$TargetCannon_Down_Num_1)
# t.test(d$TargetCannon_salience_Low_Num_1,d$TargetCannon_salience_Medium_Num_1)
