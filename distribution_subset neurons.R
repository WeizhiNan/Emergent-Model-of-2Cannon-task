...
for (sub in c(17:17)){
  ...
  pa=paste("C:/Users/nan/Emergent/learning networks/nan network/8Neuron3Salience_Cue_Target/trainseperately/17/test_results/subset_0.0/",sep='')
  ...
  EFORcor=read.table(paste(pa1,'E_Orientation_test0.25.csv',sep=''),header=TRUE,sep=",",na.string=NULL)
...
sink(paste(pa,'salience_RedTarget_ttest.txt',sep='/'))
for (i in 1:30){
...
sink(paste(pa,'salience_BlueTarget_ttest.txt',sep='/'))
for (i in 1:30){
...
sink(paste(pa,'Nonsalience_BlueTarget_ttest.txt',sep='/'))
for (i in 1:30){
...
sink(paste(pa,'Nonsalience_RedTarget_ttest.txt',sep='/'))
for (i in 1:30){
...
p
ggsave(p, file=paste("RedUp.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa)
write.table(data.RedUp_Cycle_average,paste(pa,'/','RedUp_cycle_average','.csv',sep=''),sep=',',col.names=NA,qmethod="double")
sink(paste(pa,'RedUp_ttest.txt',sep='/'))
for (i in 1:30){
...
p
ggsave(p, file=paste("RedDown.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa)
write.table(data.RedDown_Cycle_average,paste(pa,'/','RedDown_cycle_average','.csv',sep=''),sep=',',col.names=NA,qmethod="double")
sink(paste(pa,'RedDown_ttest.txt',sep='/'))
for (i in 1:30){
...
p
ggsave(p, file=paste("BlueUp.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa)
write.table(data.BlueUp_Cycle_average,paste(pa,'/','BlueUp_cycle_average','.csv',sep=''),sep=',',col.names=NA,qmethod="double")
sink(paste(pa,'BlueUp_ttest.txt',sep='/'))
for (i in 1:30){
...
p
ggsave(p, file=paste("BlueDown.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa)
write.table(data.BlueDown_Cycle_average,paste(pa,'/','BlueDown_cycle_average','.csv',sep=''),sep=',',col.names=NA,qmethod="double")
sink(paste(pa,'BlueDown_ttest.txt',sep='/'))
for (i in 1:30){
