...
for (threshold in c('0.10','0.15','0.20','0.25','0.30','0.35','0.40','0.45','0.50',
  ...
  for( sub in c(1:30)){  
    ...
    data.raw=subset(data.raw,sse==0)
    data.raw=subset(data.raw,minus_cycles!=100)
...
write.table(E_Orientation_rsquare,paste(pa,'/','E_Orientation_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("B_Orientation_Rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(B_Orientation_rsquare_01_1,paste(pa,'/','B_Orientation_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(B_Orientation_rsquare_1,paste(pa,'/','B_Orientation_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("R_Orientation_Rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(R_Orientation_rsquare_01_1,paste(pa,'/','R_Orientation_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(R_Orientation_rsquare_1,paste(pa,'/','R_Orientation_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
data.BlueTarget_1=subset(data.BlueTarget_1,R_Ori=='')
data.BlueTarget_1=subset(data.BlueTarget_1,E_Ori=='')
data.BlueTarget_1=subset(data.BlueTarget_1,Ratio=='High')
...
ggsave(p, file=paste("Blue_Target_Location_rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(Blue_Target_Location_rsquare_01_1,paste(pa,'/','Blue_Target_Location_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(Blue_Target_Location_rsquare_1,paste(pa,'/','Blue_Target_Location_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("Red_Target_Location_rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(Red_Target_Location_rsquare_01_1,paste(pa,'/','Red_Target_Location_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(Red_Target_Location_rsquare_1,paste(pa,'/','Red_Target_Location_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("Target_Location_rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(Target_Location_rsquare_01_1,paste(pa,'/','Target_Location_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(Target_Location_rsquare_1,paste(pa,'/','Target_Location_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("TargetCannon_0_rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(TargetCannon_0_rsquare_01_1,paste(pa,'/','TargetCannon_0_rsquare_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(TargetCannon_0_rsquare_1,paste(pa,'/','TargetCannon_0_rsquare_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("TargetCannon_180_rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(TargetCannon_180_rsquare_01_1,paste(pa,'/','TargetCannon_180_rsquare_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(TargetCannon_180_rsquare_1,paste(pa,'/','TargetCannon_180_rsquare_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("TargetCannon_Up_rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(TargetCannon_Up_rsquare_01_1,paste(pa,'/','TargetCannon_Up_rsquare_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(TargetCannon_Up_rsquare_1,paste(pa,'/','TargetCannon_Up_rsquare_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("TargetCannon_Down_rsquare_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(TargetCannon_Down_rsquare_01_1,paste(pa,'/','TargetCannon_Down_rsquare_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(TargetCannon_Down_rsquare_1,paste(pa,'/','TargetCannon_Down_rsquare_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("TargetCannon_salience_Low_rsquare_1_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(TargetCannon_salience_Low_rsquare_01_1,paste(pa,'/','TargetCannon_salience_Low_rsquare_01_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(TargetCannon_salience_Low_rsquare_1,paste(pa,'/','TargetCannon_salience_Low_rsquare_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("TargetCannon_salience_Medium_rsquare_1_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(TargetCannon_salience_Medium_rsquare_01_1,paste(pa,'/','TargetCannon_salience_Medium_rsquare_01_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(TargetCannon_salience_Medium_rsquare_1,paste(pa,'/','TargetCannon_salience_Medium_rsquare_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
...
ggsave(p, file=paste("TargetCannon_salience_High_rsquare_1_test_",threshold,".png",sep=''),
       width=4, height=4, dpi=150, bg="transparent",path=pa)
write.table(TargetCannon_salience_High_rsquare_01_1,paste(pa,'/','TargetCannon_salience_High_rsquare_01_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
write.table(TargetCannon_salience_High_rsquare_1,paste(pa,'/','TargetCannon_salience_High_rsquare_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
