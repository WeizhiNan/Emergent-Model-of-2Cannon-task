...
thr=as.numeric(threshold)
  ...
  # for( sub in c(1:30)){  
    sub=25
    ##Set directory 
    pa0=paste('C:/Users/nan/Emergent/learning networks/nan network/8Neuron3SalienceModel/',sub,sep='')
    pa=paste(pa0,'test_results',sep='/')
    data.raw<-read.table(paste(pa0,'/','TrialtestOutputData.csv',sep=''),header=TRUE,sep=",",na.string=NULL)    
    data.raw=subset(data.raw,X.sse=0)
    data.raw=subset(data.raw,X.minus_cycles!=200)
    
    
    data.EFOR=subset(data.raw,X.E_Ori!="")
    data.EFOR=subset(data.EFOR,X.TargetColor=='')
    a=c(data.EFOR$X.E_Ori=='E_UR')
    data.EFOR$EFOR[a]=1
    a=c(data.EFOR$X.E_Ori=='E_R')
    data.EFOR$EFOR[a]=2
    a=c(data.EFOR$X.E_Ori=='E_DR')
    data.EFOR$EFOR[a]=3
    a=c(data.EFOR$X.E_Ori=='E_D')
    data.EFOR$EFOR[a]=4
    a=c(data.EFOR$X.E_Ori=='E_DL')
    data.EFOR$EFOR[a]=5
    a=c(data.EFOR$X.E_Ori=='E_L')
    data.EFOR$EFOR[a]=6
    a=c(data.EFOR$X.E_Ori=='E_UL')
    data.EFOR$EFOR[a]=7
    a=c(data.EFOR$X.E_Ori=='E_U')
    data.EFOR$EFOR[a]=8
    ##EFOR_Orientation
    ##ordre data according to variable X.E_Ori
    input_pattern=data.EFOR$EFOR
    data.hidden.act=data.EFOR[,19:118]#10*10
...
#            width=4, height=4, dpi=150, bg="transparent",path=pa)
    ...
    data.BlueCannon_1=subset(data.raw,X.B_Ori!='')
    data.BlueCannon_1=subset(data.BlueCannon_1,X.R_Ori=='')
    data.BlueCannon_1=subset(data.BlueCannon_1,X.E_Ori=='')
    data.BlueCannon_1=subset(data.BlueCannon_1,X.Ratio=='High')
    a=c(data.BlueCannon_1$X.B_Ori=='B_UR')
    data.BlueCannon_1$BlueCannon[a]=1
    a=c(data.BlueCannon_1$X.B_Ori=='B_R')
    data.BlueCannon_1$BlueCannon[a]=2
    a=c(data.BlueCannon_1$X.B_Ori=='B_DR')
    data.BlueCannon_1$BlueCannon[a]=3
    a=c(data.BlueCannon_1$X.B_Ori=='B_D')
    data.BlueCannon_1$BlueCannon[a]=4
    a=c(data.BlueCannon_1$X.B_Ori=='B_DL')
    data.BlueCannon_1$BlueCannon[a]=5
    a=c(data.BlueCannon_1$X.B_Ori=='B_L')
    data.BlueCannon_1$BlueCannon[a]=6
    a=c(data.BlueCannon_1$X.B_Ori=='B_UL')
    data.BlueCannon_1$BlueCannon[a]=7
    a=c(data.BlueCannon_1$X.B_Ori=='B_U')
    data.BlueCannon_1$BlueCannon[a]=8
    ##BlueCannon_Orientation
    input_pattern=data.BlueCannon_1$BlueCannon
    data.hidden.act=data.BlueCannon_1[,19:118]#10*10
    ...
    data.RedCannon_1=subset(data.raw,X.R_Ori!='')
    data.RedCannon_1=subset(data.RedCannon_1,X.B_Ori=='')
    data.RedCannon_1=subset(data.RedCannon_1,X.E_Ori=='')
    data.RedCannon_1=subset(data.RedCannon_1,X.Ratio=='High')
    a=c(data.RedCannon_1$X.R_Ori=='R_UR')
    data.RedCannon_1$RedCannon[a]=1
    a=c(data.RedCannon_1$X.R_Ori=='R_R')
    data.RedCannon_1$RedCannon[a]=2
    a=c(data.RedCannon_1$X.R_Ori=='R_DR')
    data.RedCannon_1$RedCannon[a]=3
    a=c(data.RedCannon_1$X.R_Ori=='R_D')
    data.RedCannon_1$RedCannon[a]=4
    a=c(data.RedCannon_1$X.R_Ori=='R_DL')
    data.RedCannon_1$RedCannon[a]=5
    a=c(data.RedCannon_1$X.R_Ori=='R_L')
    data.RedCannon_1$RedCannon[a]=6
    a=c(data.RedCannon_1$X.R_Ori=='R_UL')
    data.RedCannon_1$RedCannon[a]=7
    a=c(data.RedCannon_1$X.R_Ori=='R_U')
    data.RedCannon_1$RedCannon[a]=8
    ##RedCannon_Orientation
    ##ordre data according to variable X.E_Ori
    input_pattern=data.RedCannon_1$RedCannon
    data.hidden.act=data.RedCannon_1[,19:118]#10*10
    ...
    data.BlueTarget_1=subset(data.raw,X.B_Ori!='')
    data.BlueTarget_1=subset(data.BlueCannon_1,X.R_Ori=='')
    data.BlueTarget_1=subset(data.BlueCannon_1,X.E_Ori=='')
    data.BlueTarget_1=subset(data.BlueCannon_1,X.Ratio=='High')
    a=c(data.BlueTarget_1$X.T_Loc=='T_UR')
    data.BlueTarget_1$BlueTarget[a]= 1
    a=c(data.BlueTarget_1$X.T_Loc=='T_R')
    data.BlueTarget_1$BlueTarget[a]= 2
    a=c(data.BlueTarget_1$X.T_Loc=='T_DR')
    data.BlueTarget_1$BlueTarget[a]= 3
    a=c(data.BlueTarget_1$X.T_Loc=='T_D')
    data.BlueTarget_1$BlueTarget[a]= 4
    a=c(data.BlueTarget_1$X.T_Loc=='T_DL')
    data.BlueTarget_1$BlueTarget[a]= 5
    a=c(data.BlueTarget_1$X.T_Loc=='T_L')
    data.BlueTarget_1$BlueTarget[a]= 6
    a=c(data.BlueTarget_1$X.T_Loc=='T_UL')
    data.BlueTarget_1$BlueTarget[a]= 7
    a=c(data.BlueTarget_1$X.T_Loc=='T_U')
    data.BlueTarget_1$BlueTarget[a]= 8
    input_pattern=data.BlueTarget_1$BlueTarget
    data.hidden.act=data.BlueTarget_1[,19:118]#10*10
    ...
    ##Red_Target_Location
    data.RedTarget_1=subset(data.raw,X.R_Ori!='')
    data.RedTarget_1=subset(data.RedTarget_1,X.B_Ori=='')
    data.RedTarget_1=subset(data.RedTarget_1,X.E_Ori=='')
    data.RedTarget_1=subset(data.RedTarget_1,X.Ratio=='High')
    a=c(data.RedTarget_1$X.T_Loc=='T_UR')
    data.RedTarget_1$RedTarget[a]= 1
    a=c(data.RedTarget_1$X.T_Loc=='T_R')
    data.RedTarget_1$RedTarget[a]= 2
    a=c(data.RedTarget_1$X.T_Loc=='T_DR')
    data.RedTarget_1$RedTarget[a]= 3
    a=c(data.RedTarget_1$X.T_Loc=='T_D')
    data.RedTarget_1$RedTarget[a]= 4
    a=c(data.RedTarget_1$X.T_Loc=='T_DL')
    data.RedTarget_1$RedTarget[a]= 5
    a=c(data.RedTarget_1$X.T_Loc=='T_L')
    data.RedTarget_1$RedTarget[a]= 6
    a=c(data.RedTarget_1$X.T_Loc=='T_UL')
    data.RedTarget_1$RedTarget[a]= 7
    a=c(data.RedTarget_1$X.T_Loc=='T_U')
    data.RedTarget_1$RedTarget[a]= 8
    input_pattern=data.RedTarget_1$RedTarget
    data.hidden.act=data.RedTarget_1[,19:118]#10*10
    ...
    ##Target_Location
    data.Target_1=subset(data.raw,X.E_Ori!="")
    data.Target_1=subset(data.Target_1,X.TargetColor=='')
    a=c(data.Target_1$X.T_Loc=='T_UR')
    data.Target_1$Target[a]= 1
    a=c(data.Target_1$X.T_Loc=='T_R')
    data.Target_1$Target[a]= 2
    a=c(data.Target_1$X.T_Loc=='T_DR')
    data.Target_1$Target[a]= 3
    a=c(data.Target_1$X.T_Loc=='T_D')
    data.Target_1$Target[a]= 4
    a=c(data.Target_1$X.T_Loc=='T_DL')
    data.Target_1$Target[a]= 5
    a=c(data.Target_1$X.T_Loc=='T_L')
    data.Target_1$Target[a]= 6
    a=c(data.Target_1$X.T_Loc=='T_UL')
    data.Target_1$Target[a]= 7
    a=c(data.Target_1$X.T_Loc=='T_U')
    data.Target_1$Target[a]= 8
    input_pattern=data.Target_1$Target
    data.hidden.act=data.Target_1[,19:118]#10*10
    ...
    ## Cannon 0
    data.CannonAngle0_1=subset(data.raw,X.CannonAngle!='')
    data.CannonAngle0_1=subset(data.CannonAngle0_1,X.E_Ori=='')
    data.CannonAngle0_1=subset(data.CannonAngle0_1,X.CannonAngle=="0")
    a=c(data.CannonAngle0_1$X.TargetColor=="Blue")
    data.CannonAngle0_1$TargetColor[a]=1
    data.CannonAngle0_1$TargetColor[!a]=2
    input_pattern=data.CannonAngle0_1$TargetColor
    data.hidden.act=data.CannonAngle0_1[,19:118]#10*10
    ...
    ## Cannon 180
    data.CannonAngle180_1=subset(data.raw,X.CannonAngle!='')
    data.CannonAngle180_1=subset(data.CannonAngle180_1,X.E_Ori=='')
    data.CannonAngle180_1=subset(data.CannonAngle180_1,X.CannonAngle=="180")
    data.CannonAngle180_1=subset(data.CannonAngle180_1,X.sse==0)
    a=c(data.CannonAngle180_1$X.TargetColor=="Blue")
    data.CannonAngle180_1$TargetColor[a]=1
    data.CannonAngle180_1$TargetColor[!a]=2
    input_pattern=data.CannonAngle180_1$TargetColor
    data.hidden.act=data.CannonAngle180_1[,19:118]#10*10
    ...
    ##TargetCannon_Up_Num
    data.TargetCannon_Up_1=subset(data.raw,X.E_Ori=='E_U')
    data.TargetCannon_Up_1=subset(data.TargetCannon_Up_1,X.Ratio=='High')
    data.TargetCannon_Up_1=subset(data.TargetCannon_Up_1,X.TargetColor!="")
    # data.TargetCannon_Up_1=subset(data.TargetCannon_Up_1,X.Orientation=="U")
    data.TargetCannon_Up_1=subset(data.TargetCannon_Up_1,X.Orientation!="D")
    data.TargetCannon_Up_1=subset(data.TargetCannon_Up_1,X.Orientation!="DL")
    data.TargetCannon_Up_1=subset(data.TargetCannon_Up_1,X.Orientation!="DR")
    data.TargetCannon_Up_1=subset(data.TargetCannon_Up_1,X.Orientation!="L")
    data.TargetCannon_Up_1=subset(data.TargetCannon_Up_1,X.Orientation!="R")
    a=c(data.TargetCannon_Up_1$X.TargetColor=="Red")
    data.TargetCannon_Up_1$TargetColor[a]=1
    data.TargetCannon_Up_1$TargetColor[!a]=2
    input_pattern=data.TargetCannon_Up_1$TargetColor
    data.hidden.act=data.TargetCannon_Up_1[,19:118]#10*10
    ...
    data.TargetCannon_Down_1=subset(data.raw,X.E_Ori=='E_U')
    data.TargetCannon_Down_1=subset(data.TargetCannon_Down_1,X.Ratio=='High')
    data.TargetCannon_Down_1=subset(data.TargetCannon_Down_1,X.TargetColor!="")
    # data.TargetCannon_Down_1=subset(data.TargetCannon_Down_1,X.Orientation=="D")
    data.TargetCannon_Down_1=subset(data.TargetCannon_Down_1,X.Orientation!="U")
    data.TargetCannon_Down_1=subset(data.TargetCannon_Down_1,X.Orientation!="UL")
    data.TargetCannon_Down_1=subset(data.TargetCannon_Down_1,X.Orientation!="UR")
    data.TargetCannon_Down_1=subset(data.TargetCannon_Down_1,X.Orientation!="L")
    data.TargetCannon_Down_1=subset(data.TargetCannon_Down_1,X.Orientation!="R")
    a=c(data.TargetCannon_Down_1$X.TargetColor=="Red")
    data.TargetCannon_Down_1$TargetColor[a]=1
    data.TargetCannon_Down_1$TargetColor[!a]=2
    input_pattern=data.TargetCannon_Down_1$TargetColor
    data.hidden.act=data.TargetCannon_Down_1[,19:118]#10*10
    ...
    data.salience_Low_1=subset(data.raw,X.Ratio!='')
    data.salience_Low_1=subset(data.salience_Low_1,X.E_Ori=="")
    data.salience_Low_1=subset(data.salience_Low_1,X.Ratio=="Low")
    a=c(data.salience_Low_1$X.TargetColor=="Blue")
    data.salience_Low_1$TargetColor[a]=1
    data.salience_Low_1$TargetColor[!a]=2
    input_pattern=data.salience_Low_1$TargetColor
    data.hidden.act=data.salience_Low_1[,19:118]#10*10
    ...
    data.salience_Medium_1=subset(data.raw,X.Ratio!='')
    data.salience_Medium_1=subset(data.salience_Medium_1,X.E_Ori=="")
    data.salience_Medium_1=subset(data.salience_Medium_1,X.Ratio=="Medium")
    a=c(data.salience_Medium_1$X.TargetColor=="Blue")
    data.salience_Medium_1$TargetColor[a]=1
    data.salience_Medium_1$TargetColor[!a]=2
    input_pattern=data.salience_Medium_1$TargetColor
    data.hidden.act=data.salience_Medium_1[,19:118]#10*10
    ...
    data.salience_High_1=subset(data.raw,X.Ratio!='')
    data.salience_High_1=subset(data.salience_High_1,X.E_Ori=="")
    data.salience_High_1=subset(data.salience_High_1,X.Ratio=="High")
    data.salience_High_1$CannonAngle=1
    a=c(data.salience_High_1$X.CannonAngle>=0)
    data.salience_High_1$CannonAngle[a]=0
    data.salience_High_1=subset(data.salience_High_1,CannonAngle==1)
    a=c(data.salience_High_1$X.TargetColor=="Blue")
    data.salience_High_1$TargetColor[a]=1
    data.salience_High_1$TargetColor[!a]=2
    input_pattern=data.salience_High_1$TargetColor
    data.hidden.act=data.salience_High_1[,19:118]#10*10
    ...
    max1=max(max(E_Orientation_rsquare),max(B_Orientation_rsquare_1), max(R_Orientation_rsquare_1))
    min1=min(min(E_Orientation_rsquare),min(B_Orientation_rsquare_1),min(B_Orientation_rsquare_1))
    limit=c(0,0.4)
    p=heatmapplot(E_Orientation_rsquare,limit)
    ggsave(p, file=paste("E_Orientation_Rsquare_test_",threshold,".png",sep=''),
               width=4, height=4, dpi=150, bg="transparent",path=pa)    
    ...
    max2=max(max(Target_Location_rsquare_1),max(Blue_Target_Location_rsquare_1), max(Red_Target_Location_rsquare_1))
    min2=min(min(Target_Location_rsquare_1),min(Blue_Target_Location_rsquare_1),min(Red_Target_Location_rsquare_1))
    max2
    min2
    limit=c(0,0.6)
    p=heatmapplot(Target_Location_rsquare_1,limit)
    ggsave(p, file=paste("Target_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)  
    p=heatmapplot(Blue_Target_Location_rsquare_1,limit)
    ggsave(p, file=paste("Blue_Target_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)        
    p=heatmapplot(Red_Target_Location_rsquare_1,limit)
    ggsave(p, file=paste("Red_Target_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)       

    max3=max(max(TargetCannon_0_rsquare_1),max(TargetCannon_180_rsquare_1))
    min3=min(min(TargetCannon_0_rsquare_1),min(TargetCannon_180_rsquare_1))
    max3
    min3
    limit=c(0,1.0)
    p=heatmapplot(TargetCannon_0_rsquare_1,limit)
    ggsave(p, file=paste("TargetCannon_0_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)  
    p=heatmapplot(TargetCannon_180_rsquare_1,limit)
    ggsave(p, file=paste("TargetCannon_180_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)  
    
    max4=max(max(TargetCannon_Up_rsquare_1),max(TargetCannon_Down_rsquare_1))
    min4=min(min(TargetCannon_Up_rsquare_1),min(TargetCannon_Down_rsquare_1))
    max4
    min4
    limit=c(0,1.0)
    p=heatmapplot(TargetCannon_Up_rsquare_1,limit)
    ggsave(p, file=paste("TargetCannon_Up_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)  
    p=heatmapplot(TargetCannon_Down_rsquare_1,limit)
    ggsave(p, file=paste("TargetCannon_Down_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)  
    
    max5=max(max(TargetCannon_salience_Low_rsquare_1),max(TargetCannon_salience_Medium_rsquare_1),max(TargetCannon_salience_High_rsquare_1))
    min5=min(min(TargetCannon_salience_Low_rsquare_1),min(TargetCannon_salience_Medium_rsquare_1),min(TargetCannon_salience_High_rsquare_1))
    max5
    min5
    limit=c(0,1.0)
    p=heatmapplot(TargetCannon_salience_Low_rsquare_1,limit)
    ggsave(p, file=paste("TargetCannon_Salience_Low_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)  
    p=heatmapplot(TargetCannon_salience_Medium_rsquare_1,limit)
    ggsave(p, file=paste("TargetCannon_Salience_Medium_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa) 
    p=heatmapplot(TargetCannon_salience_High_rsquare_1,limit)
    ggsave(p, file=paste("TargetCannon_Salience_High_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa) 
...
#       TargetCannon_salience_Low_Num_1,TargetCannon_salience_Medium_Num_1,TargetCannon_salience_High_Num_1,share_salience_num_1
#     )
#     write.table(totalnumber,paste(pa,'/','Total Number_',threshold,'_',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
#     
...
#   pa1=paste('C:/Users/nan/Emergent/learning networks/nan network/8Neuron3SalienceModel/test_results',sep='')
#   ##wirte all subjects neuron number out
#   write.table(tt,paste(pa1,'/','Total Number_',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
}   
