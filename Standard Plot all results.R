...
############ Act_w("End of Cue",0.0) in Orientation Effect
  ...
  temp=Cycle10_RedDown_cycle
  titlename="Red Target Cannon Point Down"
  p=temp_process(temp,titlename,RedDown)
  p
  ggsave(p, file=paste("Cycle10_RedDown_0.0.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p3=p
  ...
  temp=Cycle10_BlueDown_cycle
  titlename="Blue Target Cannon Point Down"
  p=temp_process(temp,titlename,BlueDown)
  p
  ggsave(p, file=paste("Cycle10_BlueDown_0.0.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p4=p
  
  require(gridExtra)
  p=grid.arrange(p1, p2,p3,p4, ncol=2)
  ggsave(p, file=paste("Cycle10_Orientation Effect_0.0.png",sep=''),width=16, height=8, dpi=150, bg="transparent",path=pa_export)
###################
###################
  ...
  temp=Cycle10_data.Nonsalience_BlueTarget_cycle
  titlename="Red Salient Cannon and Blue Target"
  p=temp_process(temp,titlename,NonSalience_BlueTarget_meanCycle)
  p
  ggsave(p, file=paste("Cycle10_RedSalienceBlueTarget_0.0.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p1=p
  ...
  temp=Cycle10_data.Nonsalience_RedTarget_cycle
  titlename="Blue Salient Cannon and Red Target"
  p=temp_process(temp,titlename,NonSalience_RedTarget_meanCycle)
  p
  ggsave(p, file=paste("Cycle10_BlueSalienceRedTarget_0.0.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p2=p
  ...
  temp=Cycle10_data.salience_BlueTarget_cycle
  titlename="Blue Salient Cannon and Blue Target"
  p=temp_process(temp,titlename,Salience_BlueTarget_meanCycle)
  p
  ggsave(p, file=paste("Cycle10_BlueSalienceBlueTarget_0.0.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p3=p
  ...
  temp=Cycle10_data.salience_RedTarget_cycle
  titlename="Red Salient Cannon and Red Target"
  p=temp_process(temp,titlename,Salience_RedTarget_meanCycle)
  p
  ggsave(p, file=paste("Cycle10_RedSalienceRedTarget_0.0.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p4=p
  
  require(gridExtra)
  p=grid.arrange(p4,p3,p2, p1, ncol=2)
  ggsave(p, file=paste("Cycle10_Salience Effect_0.0.png",sep=''),width=16, height=8, dpi=150, bg="transparent",path=pa_export)
  ###################
  ###################
  ...
  p=temp_process(temp,titlename,RedUp)
  p
  ggsave(p, file=paste("Cycle10_RedUp_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p1=p
  ...
  p=temp_process(temp,titlename,BlueUp)
  p
  ggsave(p, file=paste("Cycle10_BlueUp_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p2=p
  ...
  p=temp_process(temp,titlename,RedDown)
  p
  ggsave(p, file=paste("Cycle10_RedDown_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p3=p
  ...
  p=temp_process(temp,titlename,BlueDown)
  p
  ggsave(p, file=paste("Cycle10_BlueDown_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p4=p
  
  require(gridExtra)
  p=grid.arrange(p1, p2,p3,p4, ncol=2)
  ggsave(p, file=paste("Cycle10_Orientation Effect_0.20.png",sep=''),width=16, height=8, dpi=150, bg="transparent",path=pa_export)
  ###################
  ###################
  require(gridExtra)
  p=grid.arrange(p1,p4, ncol=2)
  ggsave(p, file=paste("Red_Cycle10_Orientation Effect_0.20.png",sep=''),width=16, height=4, dpi=150, bg="transparent",path=pa_export)
  ###################
  ###################
  ...
  p=temp_process(temp,titlename,NonSalience_BlueTarget_meanCycle)
  p
  ggsave(p, file=paste("Cycle10_RedSalienceBlueTarget_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p1=p
  ...
  p=temp_process(temp,titlename,NonSalience_RedTarget_meanCycle)
  p
  ggsave(p, file=paste("Cycle10_BlueSalienceRedTarget_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p2=p
  ...
  p=temp_process(temp,titlename,Salience_BlueTarget_meanCycle)
  p
  ggsave(p, file=paste("Cycle10_BlueSalienceBlueTarget_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p3=p
  ...
  p=temp_process(temp,titlename,Salience_RedTarget_meanCycle)
  p
  ggsave(p, file=paste("Cycle10_RedSalienceRedTarget_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p4=p
  
  require(gridExtra)
  p=grid.arrange(p4,p3,p2, p1, ncol=2)
  ggsave(p, file=paste("Cycle10_Salience Effect_0.20.png",sep=''),width=16, height=8, dpi=150, bg="transparent",path=pa_export)
  ###################
  ###################
  
  require(gridExtra)
  p=grid.arrange(p4,p1, ncol=2)
  ggsave(p, file=paste("Red_Cycle10_Salience Effect_0.20.png",sep=''),width=16, height=4, dpi=150, bg="transparent",path=pa_export)
  ###################
  ###################
  ...
  ############ Act_w("End of Trial",0.0) in Orientation Effect
  ...
  ############ Act_w("End of Trial",0.0) in Salience Effect 
  ...
  p=temp_process(temp,titlename,NonSalience_RedTarget_meanCycle)
  p
  ggsave(p, file=paste("BlueSalienceRedTarget_0.0.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p2=p
  ...
  ############ Act_w("End of Trial",0.20) in Orientation Effect
  ...
  require(gridExtra)
  p=grid.arrange(p1,p4, ncol=2)
  ggsave(p, file=paste("Red_Orientation Effect_0.20.png",sep=''),width=16, height=4, dpi=150, bg="transparent",path=pa_export)
  ###################
  ###################
  
  ############ Act_w("End of Trial",0.20) in Salience Effect 
  ...
  p=temp_process(temp,titlename,NonSalience_RedTarget_meanCycle)
  p
  ggsave(p, file=paste("BlueSalienceRedTarget_0.20.png",sep=''),width=8, height=4, dpi=150, bg="transparent",path=pa_export)
  p2=p
  ...
  require(gridExtra)
  p=grid.arrange(p4,p1, ncol=2)
  ggsave(p, file=paste("Red_Salience Effect_0.20.png",sep=''),width=16, height=4, dpi=150, bg="transparent",path=pa_export)
  ###################
  ###################
