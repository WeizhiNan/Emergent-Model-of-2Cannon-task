...
#                     '0.55','0.60','0.65','0.70','0.75','0.80','0.85','0.90','0.95')){
  ...
  for( sub in c(1:30)){  
    ...
    write.table(E_Orientation_rsquare_01,paste(pa,'/','E_Orientation_01_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(E_Orientation_rsquare,paste(pa,'/','E_Orientation_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    ggsave(p, file=paste("B_Orientation_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)
    write.table(B_Orientation_rsquare_01_1,paste(pa,'/','B_Orientation_01_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(B_Orientation_rsquare_1,paste(pa,'/','B_Orientation_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    ggsave(p, file=paste("R_Orientation_Rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)
    write.table(R_Orientation_rsquare_01_1,paste(pa,'/','R_Orientation_01_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(R_Orientation_rsquare_1,paste(pa,'/','R_Orientation_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    ggsave(p, file=paste("Blue_Target_Location_rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)
    write.table(Blue_Target_Location_rsquare_01_1,paste(pa,'/','Blue_Target_Location_01_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(Blue_Target_Location_rsquare_1,paste(pa,'/','Blue_Target_Location_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    ggsave(p, file=paste("Red_Target_Location_rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)
    write.table(Red_Target_Location_rsquare_01_1,paste(pa,'/','Red_Target_Location_01_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(Red_Target_Location_rsquare_1,paste(pa,'/','Red_Target_Location_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    ggsave(p, file=paste("Target_Location_rsquare_test_",threshold,".png",sep=''),
           width=4, height=4, dpi=150, bg="transparent",path=pa)
    write.table(Target_Location_rsquare_01_1,paste(pa,'/','Target_Location_01_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(Target_Location_rsquare_1,paste(pa,'/','Target_Location_test',threshold,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
