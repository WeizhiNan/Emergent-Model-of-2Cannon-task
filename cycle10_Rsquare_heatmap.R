...
{ 
  ...
  for( sub in c(1:30)){  
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(Blue_Target_Location_rsquare_01,paste(pa,'/','Cycle10_Blue_Target_Location_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(Blue_Target_Location_rsquare_1,paste(pa,'/','Cycle10_Blue_Target_Location_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(Red_Target_Location_rsquare_01,paste(pa,'/','Cycle10_Red_Target_Location_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(Red_Target_Location_rsquare_1,paste(pa,'/','Cycle10_Red_Target_Location_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(Target_Location_rsquare_01,paste(pa,'/','Cycle10_Target_Location_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(Target_Location_rsquare_1,paste(pa,'/','Cycle10_Target_Location_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    data.hidden.act=data.CannonAngle0_1[,16:115]#10*10
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(TargetCannon_0_rsquare_01,paste(pa,'/','Cycle10_TargetCannon_0_rsquare_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(TargetCannon_0_rsquare_1,paste(pa,'/','Cycle10_TargetCannon_0_rsquare_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    data.hidden.act=data.CannonAngle180_1[,16:115]#10*10
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(TargetCannon_180_rsquare_01,paste(pa,'/','Cycle10_TargetCannon_180_rsquare_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(TargetCannon_180_rsquare_1,paste(pa,'/','Cycle10_TargetCannon_180_rsquare_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    data.hidden.act=data.TargetCannon_Up_1[,16:115]#10*10
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(TargetCannon_Up_rsquare_01,paste(pa,'/','Cycle10_TargetCannon_Up_rsquare_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(TargetCannon_Up_rsquare_1,paste(pa,'/','Cycle10_TargetCannon_Up_rsquare_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    data.hidden.act=data.TargetCannon_Down_1[,16:115]#10*10
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(TargetCannon_Down_rsquare_01,paste(pa,'/','Cycle10_TargetCannon_Down_rsquare_01_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(TargetCannon_Down_rsquare_1,paste(pa,'/','Cycle10_TargetCannon_Down_rsquare_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    data.hidden.act=data.salience_Low_1[,16:115]#10*10
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(TargetCannon_salience_Low_rsquare_01_1,paste(pa,'/','Cycle10_TargetCannon_salience_Low_rsquare_01_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(TargetCannon_salience_Low_rsquare_1,paste(pa,'/','Cycle10_TargetCannon_salience_Low_rsquare_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    data.hidden.act=data.salience_Medium_1[,16:115]#10*10
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(TargetCannon_salience_Medium_rsquare_01_1,paste(pa,'/','Cycle10_TargetCannon_salience_Medium_rsquare_01_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(TargetCannon_salience_Medium_rsquare_1,paste(pa,'/','Cycle10_TargetCannon_salience_Medium_rsquare_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    ...
    data.hidden.act=data.salience_High_1[,16:115]#10*10
    ...
    #        width=4, height=4, dpi=150, bg="transparent",path=pa)
    # write.table(TargetCannon_salience_High_rsquare_01_1,paste(pa,'/','Cycle10_TargetCannon_salience_High_rsquare_01_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
    write.table(TargetCannon_salience_High_rsquare_1,paste(pa,'/','Cycle10_TargetCannon_salience_High_rsquare_1_test',sub,'.csv',sep=''),sep=',',col.names=NA,qmethod="double")
  ...
  for (threshold in c('0.10','0.15','0.20','0.25','0.30','0.35','0.40','0.45','0.50',
    ...
    for( sub in c(1:30)){
      ...
      TLoc_rsquare<-read.table(paste(pa,'/','Cycle10_Target_Location_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      Blue_TLoc_rsquare<-read.table(paste(pa,'/','Cycle10_Blue_Target_Location_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      Red_TLoc_rsquare<-read.table(paste(pa,'/','Cycle10_Red_Target_Location_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      TargetCannon_0_rsquare<-read.table(paste(pa,'/','Cycle10_TargetCannon_0_rsquare_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      TargetCannon_180_rsquare<-read.table(paste(pa,'/','Cycle10_TargetCannon_180_rsquare_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      TargetCannon_Up_rsquare<-read.table(paste(pa,'/','Cycle10_TargetCannon_Up_rsquare_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      TargetCannon_Down_rsquare<-read.table(paste(pa,'/','Cycle10_TargetCannon_Down_rsquare_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      TargetCannon_salience_Low_rsquare<-read.table(paste(pa,'/','Cycle10_TargetCannon_salience_Low_rsquare_1_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      TargetCannon_salience_Medium_rsquare<-read.table(paste(pa,'/','Cycle10_TargetCannon_salience_Medium_rsquare_1_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      TargetCannon_salience_High_rsquare<-read.table(paste(pa,'/','Cycle10_TargetCannon_salience_High_rsquare_1_test',sub,'.csv',sep=''),header=TRUE,sep=",",na.string=NULL) 
      ...
      TLoc_rsquare_01<-Rsquare_01(TLoc_rsquare,thr)
      Blue_TLoc_rsquare_01<-Rsquare_01(Blue_TLoc_rsquare,thr) 
      Red_TLoc_rsquare_01<-Rsquare_01(Red_TLoc_rsquare,thr)
      TargetCannon_0_rsquare_01<-Rsquare_01(TargetCannon_0_rsquare,thr)
      TargetCannon_180_rsquare_01<-Rsquare_01(TargetCannon_180_rsquare,thr)
      TargetCannon_Up_rsquare_01<-Rsquare_01(TargetCannon_Up_rsquare,thr)
      TargetCannon_Down_rsquare_01<-Rsquare_01(TargetCannon_Down_rsquare,thr)
      TargetCannon_salience_Low_rsquare_01<-Rsquare_01(TargetCannon_salience_Low_rsquare,thr) 
      TargetCannon_salience_Medium_rsquare_01<-Rsquare_01(TargetCannon_salience_Medium_rsquare,thr)
      TargetCannon_salience_High_rsquare_01<-Rsquare_01(TargetCannon_salience_High_rsquare,thr)
      ...
      TLoc_Num_1=sum(TLoc_rsquare_01)
      Blue_TLoc_Num_1=sum(Blue_TLoc_rsquare_01)
      Red_TLoc_Num_1=sum(Red_TLoc_rsquare_01)
      ##compute share neuron number of two color targets
      share_target_1=Blue_TLoc_rsquare_01+Red_TLoc_rsquare_01
      a=c(share_target_1==2)
      share_BlueRed_target_num_1=sum(a)
      ##compute share neuron number of blue targets with target 
      share_Blue_target_1=Blue_TLoc_rsquare_01+TLoc_rsquare_01
      a=c(share_Blue_target_1==2)
      share_Blue_target_num_1=sum(a)
      ##compute share neuron number of red targets with target 
      share_Red_target_1=Red_TLoc_rsquare_01+TLoc_rsquare_01
      a=c(share_Red_target_1==2)
      share_Red_target_num_1=sum(a)
      ##compute share neuron number of two color targets
      share_target3_1=Red_TLoc_rsquare_01+TLoc_rsquare_01+Blue_TLoc_rsquare_01
      a=c(share_target3_1==3)
      share_BlueRed_target_num_3_1=sum(a)
 
      TargetCannon_0_Num_1=sum(TargetCannon_0_rsquare_01)
      TargetCannon_180_Num_1=sum(TargetCannon_180_rsquare_01)
      ##compute share neuron number of two target Cannon in two CannonAngle conditions
      share_targetCannon_0180_1=TargetCannon_0_rsquare_01+TargetCannon_180_rsquare_01
      a=c(share_targetCannon_0180_1==2)
      share_targetCannon_0180_num_1=sum(a)
      
      TargetCannon_Up_Num_1=sum(TargetCannon_Up_rsquare_01)
      TargetCannon_Down_Num_1=sum(TargetCannon_Down_rsquare_01)
      ##compute share neuron number of two target Cannon in two orientations conditions
      share_targetCannon_UpDown_1=TargetCannon_Up_rsquare_01+TargetCannon_Down_rsquare_01
      a=c(share_targetCannon_UpDown_1==2)
      share_targetCannon_UpDown_num_1=sum(a)

      
      TargetCannon_salience_Low_Num_1=sum(TargetCannon_salience_Low_rsquare_01)
      TargetCannon_salience_Medium_Num_1=sum(TargetCannon_salience_Medium_rsquare_01)
      TargetCannon_salience_High_Num_1=sum(TargetCannon_salience_High_rsquare_01)
      ##compute share neuron number of three saliences
      share_salience=TargetCannon_salience_High_rsquare_01+TargetCannon_salience_Medium_rsquare_01+TargetCannon_salience_Low_rsquare_01
      a=c(share_salience==3)
      share_salience_num_1=sum(a)
